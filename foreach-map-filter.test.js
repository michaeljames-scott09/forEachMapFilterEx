...
describe("#extractFulName", function() {
  ...
  xit("returns a new array with the value of each key in an array objects", function() {
...
describe("#filterByValue", function() {
  ...
  xit("returns a new array of objects that contain a key", function() {
...
describe("#find", function() {
  var arr = [1, 2, 3, 4, 5];
  xit("returns the first value found in an array", function() {
    expect(find(arr, 3)).toEqual(3);
  });
  xit("returns undefined if the value is not found", function() {
...
describe("#removeVowels", function() {
  xit("removes all vowels from a string", function() {
...
describe("#doubleOddNumbers", function() {
  xit("returns an array of all odd numbers doubled", function() {
